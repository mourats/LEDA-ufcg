...
/**
 * Primeira implementação utilizando apenas o partition of quicksort;
 * 
 * @author thiagomoura
 *
 * @param <T>
 */
public class FirstImplementationInHome<T extends Comparable<T>> implements TernaryArraySorting<T> {
